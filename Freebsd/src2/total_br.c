...
total_br()
{
  ...
  while(1)
  {
    ...
    for(ii=1;ii<=item_count;ii++)
    {
      ...
      mvprintw(li+1,15,"      全机构科目[%ld]日结单 ",sum_br[ii].item_num);
      mvprintw(li+2,15,"===================================================");
      ...
      mvprintw(li+12,15,"  开户数:%5d       销户数:%5d ",sum_br[ii].open_num,sum_br[ii].close_num);
      mvprintw(li+13,15,"===================================================");
      refresh();
    ...
    li=7;
    clear_scr(li,22,22,77);
    mvprintw(li+1,15,"         全机构凭证使用统计");
    mvprintw(li+2,15,"===================================================");
    mvprintw(li+3,15,"类型  名    称  剩余数 使用数 作废数 换折数 交回数");
    mvprintw(li+4,15,"===================================================");
    refresh();
